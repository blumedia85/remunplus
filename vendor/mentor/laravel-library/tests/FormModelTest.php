...
use Mockery as m;
use Mentordeveloper\Library\Tests\TestCase;
...
class FormModelTest extends TestCase
{
    ...
    /**
     * @expectedException \Mentordeveloper\Library\Exceptions\ValidationException
     */
    ...
    /**
     * @expectedException \Mentordeveloper\Library\Exceptions\NotFoundException
     */
    public function testProcessThrowNotFound()
    {
        $stub_validator = new ValidatorInterfaceStub();

        $mock_repo = m::mock('StdClass')->shouldReceive('update')->andThrow(new \Mentordeveloper\Library\Exceptions\NotFoundException)->getMock();
        $form = new FormModel($stub_validator, $mock_repo);
        $form->process(array("id" => "1"));
    }
...
class ValidatorInterfaceStub implements \Mentordeveloper\Library\Validators\ValidatorInterface
{
