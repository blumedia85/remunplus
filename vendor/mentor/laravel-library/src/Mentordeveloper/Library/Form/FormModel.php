<?php namespace Mentordeveloper\Library\Form;
/**
 * Class FormModel
 *
...
class FormModel implements FormInterface{
    ...
    /**
     * Validator
     * @var \Mentordeveloper\Library\Validators\ValidatorInterface
     */
    protected $v;
    /**
     ...
     * @param array $input
     * @throws \Mentordeveloper\Library\Exceptions\MentordeveloperExceptionsInterface
     */
     ...
     * @param $input
     * @throws \Mentordeveloper\Library\Exceptions\NotFundException
     */
