...
use Mentordeveloper\Authentication\Helpers\FileRouteHelper;
...
class FileRouteHelperTest extends DbTestCase
{
    ...
    {
        $users_created = $this->make('Mentordeveloper\Authentication\Models\User', array_merge($this->getUserStub(), ["permissions" => $permissions]));
