...
class UserProfilePresenterTest extends DbTestCase
{
    ...
    {
        $this->user = $this->initializeUserHasher()->make('Mentordeveloper\Authentication\Models\User', $this->getUserStub())->first();
        $this->user_profile = $this->make('Mentordeveloper\Authentication\Models\UserProfile', $this->getUserProfileStub($this->user))->first();
    }
