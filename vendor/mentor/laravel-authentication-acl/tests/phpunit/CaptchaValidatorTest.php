...
use Mentordeveloper\Authentication\Classes\Captcha\CaptchaValidator;
use Validator;
/**
...
class CaptchaValidatorTest extends TestCase {
    ...
    public function canValidateInputSuccesfullyAsLaravelValidator()
    {
        ...
        Validator::extend('captcha', 'Mentordeveloper\Authentication\Tests\Unit\CaptchaImplementationStub@validateCaptcha');
    ...
    public function canValidateInputErrorsAsLaravelValidator()
    {
        ...
        $input = ["captcha_input" => $captcha_value];
        $rules = ["captcha_input" => "captcha"];
        Validator::extend('captcha', 'Mentordeveloper\Authentication\Tests\Unit\CaptchaImplementationStub@validateCaptcha', $this->captcha_validator->getErrorMessage());
