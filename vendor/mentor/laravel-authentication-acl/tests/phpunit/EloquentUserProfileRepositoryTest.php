...
class EloquentUserProfileRepositoryTest extends DbTestCase
{
    ...
    {
        $users = $this->make('Mentordeveloper\Authentication\Models\User', $this->getUserStub());
    ...
    /**
     * @test
     * @expectedException \Mentordeveloper\Authentication\Exceptions\ProfileNotFoundException
     **/
    ...
    {
        $user = $this->make('Mentordeveloper\Authentication\Models\User', $this->getUserStub())->first();
