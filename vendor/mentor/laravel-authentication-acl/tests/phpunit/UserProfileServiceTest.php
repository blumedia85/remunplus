...
use Mentordeveloper\Authentication\Tests\Unit\Stubs\VoidRepository;
use Mentordeveloper\Authentication\Tests\Unit\Stubs\VoidValidator;
...
class UserProfileServiceTest extends DbTestCase
{
    ...
    /**
     * @test
     * @expectedException \Mentordeveloper\Library\Exceptions\InvalidException
     **/
    public function it_throw_exception_if_cannot_process()
    {
        $mock_form_profile = m::mock('Mentordeveloper\Library\Form\FormModel');
    ...
    public function it_return_user_profile_if_success()
    {
        ...
        $this->assertInstanceOf('Mentordeveloper\Authentication\Models\UserProfile', $profile);
    }
    ...
    public function it_check_for_permission_and_set_error_incase()
    {
        ...
        {
            $service->processForm(["user_id" => 1]);
        } catch(\Mentordeveloper\Authentication\Exceptions\PermissionException $e)
        {
        }
    ...
    {
        $mock_form_profile_success = m::mock('Mentordeveloper\Library\Form\FormModel')->shouldReceive('process')->andReturn($return)->getMock();
