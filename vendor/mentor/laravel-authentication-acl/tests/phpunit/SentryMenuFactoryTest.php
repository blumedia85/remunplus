 ...
 */
use Mentordeveloper\Authentication\Classes\Menu\SentryMenuFactory;
use \Config;
use Mockery as m;
...
class SentryMenuFactoryTest extends TestCase
{
    ...
    public function itCreateACollectionOfMenItem()
    {
        ...
        $this->assertInstanceOf('Mentordeveloper\Authentication\Classes\Menu\MenuItemCollection', $collection);
