...
use Mentordeveloper\Authentication\Services\ReminderService as Reminder;
use Mockery as m;
...
class ReminderServiceTest extends DbTestCase {
    ...
    /**
     * @test
     * @expectedException \Mentordeveloper\Library\Exceptions\MailException
     */
    ...
    {
        $mock_mail = m::mock('Mentordeveloper\Library\Email\MailerInterface')->shouldReceive('sendTo')
    ...
    {
        $users = $this->make('Mentordeveloper\Authentication\Models\User');
        $user = $users[0];
