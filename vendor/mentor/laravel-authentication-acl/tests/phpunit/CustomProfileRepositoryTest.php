...
use Mentordeveloper\Authentication\Models\ProfileField;
use Mentordeveloper\Authentication\Models\ProfileFieldType;
...
class CustomProfileRepositoryTest extends DbTestCase {
    ...
    public function setUp()
    {
        ...
        $users = $this->times(2)->make('Mentordeveloper\Authentication\Models\User',(function (){return $this->getUserStub();}));
        $this->user_1=  $users[0];
        $this->user_2=  $users[1];
