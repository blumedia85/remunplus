...
use Mentordeveloper\Authentication\Repository\UserRepositorySearchFilter;
use Mentordeveloper\Authentication\Tests\Unit\Traits\HourHelper;
...
class UserRepositorySearchFilterTest extends DbTestCase
{
    ...
    {
        $user_1 = $this->make('Mentordeveloper\Authentication\Models\User', $this->getUserStub())->first();
        $user_profile_1 = $this->make('Mentordeveloper\Authentication\Models\UserProfile', array_merge($this->getUserProfileStub($user_1),["first_name" => "1", "last_name" => "2"]) )->first();
        $user_2 = $this->make('Mentordeveloper\Authentication\Models\User', $this->getUserStub())->first();
        $user_profile_2 = $this->make('Mentordeveloper\Authentication\Models\UserProfile', array_merge($this->getUserProfileStub($user_2),["first_name" => "1", "last_name" => "1"]) )->first();
    ...
    {
        $this->times(2)->make('Mentordeveloper\Authentication\Models\User', function(){return $this->getUserStub();});
