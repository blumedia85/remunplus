...
class AuthControllerTest extends DbTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->current_user = $this->make('Mentordeveloper\Authentication\Models\User', $this->getUserStub())->first();
    ...
    public function it_login_client_with_success()
    {
        ...
        $this->action('POST', 'Mentordeveloper\Authentication\Controllers\AuthController@postClientLogin', [
                "email"    => $email,
                "password" => $password,
                "remember" => $remember
        ]);
    ...
    public function it_login_admin_with_success()
    {
        ...
        $this->action('POST', 'Mentordeveloper\Authentication\Controllers\AuthController@postAdminLogin', [
                "email"    => $email,
                "password" => $password,
                "remember" => $remember
        ]);
    ...
    public function it_login_client_with_error()
    {
        ...
        $this->assertRedirectedToAction('Mentordeveloper\Authentication\Controllers\AuthController@getClientLogin');
    ...
    public function it_login_admin_with_error()
    {
        ...
        $this->assertRedirectedToAction('Mentordeveloper\Authentication\Controllers\AuthController@getAdminLogin');
        $this->assertSessionHasErrors();
    }
    ...
    public function it_process_recovery_data_and_redirect_with_success()
    {
        ...
        Event::listen('mailer.sending', 'Mentordeveloper\Authentication\Tests\Unit\AuthControllerTest@checkForSingleMailData');

        $this->action('POST', 'Mentordeveloper\Authentication\Controllers\AuthController@postReminder', ["email" => $this->current_email]);
    ...
    {
        $mock_reminder_service = m::mock('Mentordeveloper\Authentication\Services\ReminderService')
                                  ->shouldReceive('send')
                                  ->once()
                                  ->andThrow(new AuthenticationErrorException)
                                  ->shouldReceive('getErrors')
                                  ->getMock();
        $this->app->instance('Mentordeveloper\Authentication\Services\ReminderService', $mock_reminder_service);

        $this->action('POST', 'Mentordeveloper\Authentication\Controllers\AuthController@postReminder');

        $this->assertRedirectedToAction('Mentordeveloper\Authentication\Controllers\AuthController@getReminder');
        $this->assertSessionHasErrors();
    }
    ...
    public function it_change_password_with_success()
    {
        ...
        $this->action('POST', 'Mentordeveloper\Authentication\Controllers\AuthController@postChangePassword', ["password" => "newpassword"]);
    ...
    public function it_change_password_with_error()
    {
        ...
        $this->assertRedirectedToAction('Mentordeveloper\Authentication\Controllers\AuthController@getChangePassword');
        $this->assertSessionHasErrors();
    }
    ...
    {
        $this->action('POST', 'Mentordeveloper\Authentication\Controllers\AuthController@postChangePassword', ["password" => ""]);
