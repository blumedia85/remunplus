...
use Mentordeveloper\Authentication\Validators\UserSignupEmailValidator;
use Mockery as m;
class UserSignupEmailValidatorTest extends DbTestCase {
    ...
    {
        Event::listen('mailer.sending', 'Mentordeveloper\Authentication\Tests\Unit\UserSignupEmailValidatorTest@checkForSingleMailData');
    }
}
