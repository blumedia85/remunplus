<?php namespace Mentordeveloper\Authentication\Tests\Unit\Middleware;

use App;
use Exception;
use Mentordeveloper\Authentication\Middleware\Config;
...
class ConfigTest extends DbTestCase {
    ...
    public function forwardAllCallsToConfig()
    {
        ...
        $config = new Config;
        $repository = m::mock('Mentordeveloper\Authentication\Middleware\Interfaces\ConfigRepositoryInterface');
