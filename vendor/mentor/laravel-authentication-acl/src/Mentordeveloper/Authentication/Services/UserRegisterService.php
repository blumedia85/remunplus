...
use Mentordeveloper\Authentication\Exceptions\TokenMismatchException;
...
use Mentordeveloper\Authentication\Validators\UserSignupValidator;
...
{
    /**
     * @var \Mentordeveloper\Authentication\Repository\Interfaces\UserRepositoryInterface
     */
    protected $user_repository;
    /**
     * @var \Mentordeveloper\Authentication\Repository\Interfaces\UserProfileRepositoryInterface
     */
    protected $profile_repository;
    /**
     * @var \Mentordeveloper\Authentication\Validators\UserSignupValidator
     */
    ...
    public function __construct(UserSignupValidator $v = null)
    {
        ...
        Event::listen('service.activated',
                      'Mentordeveloper\Authentication\Services\UserRegisterService@sendActivationEmailToClient');
    }
    ...
    /**
     * @param array $input
     * @throws \Mentordeveloper\Library\Exceptions\ValidationException
     */
     ...
     * @throws \Mentordeveloper\Authentication\Exceptions\TokenMismatchException
     */
