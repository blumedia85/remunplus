<?php namespace Mentordeveloper\Authentication;

use App;
use InstallCommand;
use Mentordeveloper\Authentication\Classes\Captcha\GregWarCaptchaValidator;
use Mentordeveloper\Authentication\Classes\CustomProfile\Repository\CustomProfileRepository;
use PrepareCommand;
use TestRunner;
use Config;
use Mentordeveloper\Authentication\Middleware\Config as ConfigMiddleware;
...
use Mentordeveloper\Authentication\Repository\EloquentPermissionRepository;
...
class AuthenticationServiceProvider extends ServiceProvider
{
    ...
    {
        $this->package('mentor/laravel-authentication-acl');
    ...
    protected function bindClasses()
    {
        ...
        $this->app->bind('Mentordeveloper\Authentication\Interfaces\AuthenticateInterface', function ()
        {
    ...
    {
        $this->app->register('Mentordeveloper\Library\LibraryServiceProvider');
