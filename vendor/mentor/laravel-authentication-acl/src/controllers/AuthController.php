...
use Mentordeveloper\Authentication\Validators\ReminderValidator;
use Mentordeveloper\Library\Exceptions\MentordeveloperExceptionsInterface;
use Mentordeveloper\Authentication\Services\ReminderService;
...
class AuthController extends Controller {
    ...
    public function postAdminLogin()
    {
        ...
        catch(MentordeveloperExceptionsInterface $e)
        {
            ...
            return Redirect::action('Mentordeveloper\Authentication\Controllers\AuthController@getAdminLogin')->withInput()->withErrors($errors);
        }

        return Redirect::to('/payadmin/users/dashboard');
    }
    ...
    public function postClientLogin()
    {
        ...
        {
            $errors = $this->authenticator->getErrors();
            return Redirect::action('Mentordeveloper\Authentication\Controllers\AuthController@getClientLogin')->withInput()->withErrors($errors);
        }
    ...
    public function postReminder()
    {
        ...
        catch(MentordeveloperExceptionsInterface $e)
        {
            ...
            return Redirect::action("Mentordeveloper\\Authentication\\Controllers\\AuthController@getReminder")->withErrors($errors);
        }
    }
    ...
    public function postChangePassword()
    {
        ...
        {
          return Redirect::action("Mentordeveloper\\Authentication\\Controllers\\AuthController@getChangePassword")->withErrors($this->reminder_validator->getErrors())->withInput();
        }
        ...
        {
            $errors = $this->reminder->getErrors();
            return Redirect::action("Mentordeveloper\\Authentication\\Controllers\\AuthController@getChangePassword")->withErrors($errors);
        }
