<div class="panel panel-info">
    ...
    <div class="panel-body">
        {{Form::open(['action' => 'Mentordeveloper\Authentication\Controllers\UserController@getList','method' => 'get'])}}
        <!-- email text field -->
        ...
        <div class="form-group">
            <a href="{{URL::action('Mentordeveloper\Authentication\Controllers\UserController@getList')}}" class="btn btn-default search-reset">Reset</a>
