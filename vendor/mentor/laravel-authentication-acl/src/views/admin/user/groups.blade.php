{{-- add group --}}
{{Form::open(["action" => "Mentordeveloper\Authentication\Controllers\UserController@addGroup", 'class' => 'form-add-group', 'role' => 'form'])}}
...
@foreach($user->groups as $group)
    {{Form::open(["action" => "Mentordeveloper\Authentication\Controllers\UserController@deleteGroup", "role"=>"form", 'name' => $group->id])}}
    <div class="form-group">
        <div class="input-group">
