...
{{-- add fields --}}
{{Form::open(["action" => "Mentordeveloper\Authentication\Controllers\UserController@addCustomFieldType", 'class' => 'form-add-profile-field', 'role' => 'form'])}}
...
{{Form::open(["action" => "Mentordeveloper\Authentication\Controllers\UserController@deleteCustomFieldType", 'name' => $profile_data->id, 'role' => 'form'])}}
<div class="form-group">
    <div class="input-group">
