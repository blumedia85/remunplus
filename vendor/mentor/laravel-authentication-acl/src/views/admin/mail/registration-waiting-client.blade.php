...
<head>
    <meta charset="utf-8">
    {{ HTML::style('packages/mentor/laravel-authentication-acl/css/mail-base.css') }}
...
<div>
    ...
    <strong>You account has been created. However, before you can use it you need to confirm your email address first by clicking the
        <a href="{{URL::action('Mentordeveloper\Authentication\Controllers\UserController@emailConfirmation', ['token' => $body['token'], 'email' => $body['email'] ] )}}">Following link</a></strong>
    <br/>
