    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{URL::action('Mentordeveloper\Authentication\Controllers\UserController@editUser',['id' => $user_profile->user_id])}}" class="btn btn-info pull-right"><i class="fa fa-pencil-square-o"></i> Edit user</a>
                    </div>
                </div>
                <div class="row">
