...
<head>
    ...
    {{ HTML::style('packages/mentor/laravel-authentication-acl/css/bootstrap.min.css') }}
    {{ HTML::style('packages/mentor/laravel-authentication-acl/css/style.css') }}
    {{ HTML::style('packages/mentor/laravel-authentication-acl/css/strength.css') }}
    {{ HTML::style('//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css') }}
    {{ HTML::style('packages/mentor/laravel-authentication-acl/css/fonts.css') }}
...
<div class="container">
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    {{Form::open(["action" => 'Mentordeveloper\Authentication\Controllers\UserController@postSignup', "method" => "POST", "id" => "user_signup"])}}
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 margin-top-10">
                        {{link_to_action('Mentordeveloper\Authentication\Controllers\AuthController@getClientLogin','Already have an account? Login here')}}
                    </div>
                </div>
                </div>
            </div>
  ...
  {{-- Js files --}}
  {{ HTML::script('packages/mentor/laravel-authentication-acl/js/vendor/jquery-1.10.2.min.js') }}
  {{ HTML::script('packages/mentor/laravel-authentication-acl/js/vendor/password_strength/strength.js') }}
