<?php namespace Mentordeveloper\Authentication\Seeds;
...
class DbSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->call('Mentordeveloper\Authentication\Seeds\PermissionSeeder');
        $this->call('Mentordeveloper\Authentication\Seeds\GroupsSeeder');
        $this->call('Mentordeveloper\Authentication\Seeds\UserSeeder');
