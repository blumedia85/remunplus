...
class Company extends \ORM implements CompanyInterface {
	 ...
	 * @return bool
	 * @throws \Cartalyst\Sentry\Company\CompanyAlreadyActivatedException
	 */
	public function attemptActivation($activationCode)
	{
		if ($this->activated)
		{
			throw new CompanyAlreadyActivatedException('Cannot attempt activation on an already activated user.');
		}
