<?php namespace Cartalyst\Sentry\Client\Eloquent;
/**
...
use Cartalyst\Sentry\Client\NameRequiredException;
use Cartalyst\Sentry\Client\GroupExistsException;
use Cartalyst\Sentry\Client\GroupInterface;
