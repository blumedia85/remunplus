...
use Cartalyst\Sentry\Client\ClientInterface;
use Cartalyst\Sentry\Client\ClientNotFoundException;
use Cartalyst\Sentry\Client\ProviderInterface;
...
class Provider implements ProviderInterface {
	 ...
	 * @var string
	 */
	protected $model = 'Cartalyst\Sentry\Client\Eloquent\Client';
